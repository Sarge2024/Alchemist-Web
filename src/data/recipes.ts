...
export const preloadedRecipes: Recipe[] = [
  {
    id: "rec-omega",
    title: "Formulação de Ômega-3 do Atlântico",
  ...
  {
    id: "rec-quinoa",
    title: "Bowl de Quinoa Bio-Disponível",
  ...
  {
    id: "rec-clorofila",
    title: "Tônico de Extrato de Clorofila",
  ...
  {
    id: "rec-poultry",
    title: "Espécime de Ave Selada em Nitrogênio",
  ...
  {
    id: "rec-berry",
    title: "Catalisador de Frutas Vermelhas e Polifenóis",
  ...
  {
    id: "rec-chia",
    title: "Tigela de Chia Antioxidante",
  ...
  {
    id: "rec-chicken",
    title: "Prato Macro-Balanceado de Frango",
